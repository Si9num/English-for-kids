...
import {
  ...
  arrForSounds,
  arrForImgs,
} from "./arrsForDataClot";

arrForSounds();
arrForImg.splice(0, arrForImg.length);
arrForImgs();

const arrForClothesPage: string[] = [];
...
`;
arrForClothesPage.push(btn);
arrForClothesPage.push(btnRep);
export { arrForClothesPage, arrForImg };
