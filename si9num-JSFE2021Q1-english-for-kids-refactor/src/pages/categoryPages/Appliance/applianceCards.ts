...
import {
  ...
  arrForSounds,
  arrForImgs,
} from "./arrsForDataAppl";

arrForSounds();
arrForImg.splice(0, arrForImg.length);
arrForImgs();
const arrForAppliancePage: string[] = [];
...
`;
arrForAppliancePage.push(btn);
arrForAppliancePage.push(btnRep);
export { arrForAppliancePage, arrForImg };
