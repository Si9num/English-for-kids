...
import {
  ...
  arrForSounds,
  arrForImgs,
} from "./arrsForDataEmot";

arrForSounds();
arrForImg.splice(0, arrForImg.length);
arrForImgs();

const arrForEmotionPage: string[] = [];
...
`;
arrForEmotionPage.push(btn);
arrForEmotionPage.push(btnRep);
export { arrForEmotionPage, arrForImg };
